if (document.transcript == null) document.transcript = "";
(function() {
    "use strict";
    var Dialog = function() {
            var dialog_el_id = "dialog",
                ...
                will_save, confirming, editing, editing_dirent, cur_usage, cur_usage_name, cur_gameid, cur_filelist;
            ...
            function dialog_open(e, t, i, r) {
                ...
                var u, f, c, d = $("#" + dialog_el_id);
                d.length && d.remove(), d = $("<div>", {
                    id: dialog_el_id
                }), (u = $("<form>")).on("submit", will_save ? evhan_accept_save_button : evhan_accept_load_button), d.append(u), c = $("<div>", {
                    class: "DiaButtonsFloat"
                }), (f = $("<button>", {
                    id: dialog_el_id + "_edit",
                    type: "button"
                })).append("Edit"), f.on("click", evhan_edit_button), c.append(f), u.append(c), (c = $("<div>", {
                    id: dialog_el_id + "_cap",
                    class: "DiaCaption"
                })).append("XXX"), u.append(c), will_save && (c = $("<div>", {
                    id: dialog_el_id + "_input",
                    class: "DiaInput"
                }), u.append(c), f = $("<input>", {
                    id: dialog_el_id + "_infield",
                    type: "text",
                    name: "filename"
                }), c.append(f), (c = $("<div>", {
                    id: dialog_el_id + "_warning",
                    class: "DiaWarning"
                })).text("Warning: data may be erased by clearing cookies or browser privacy policies."), u.append(c)), c = $("<div>", {
                    id: dialog_el_id + "_body",
                    class: "DiaBody"
                }), u.append(c), (c = $("<div>", {
                    id: dialog_el_id + "_cap2",
                    class: "DiaCaption"
                })).hide(), u.append(c), c = $("<div>", {
                    id: dialog_el_id + "_buttonrow",
                    class: "DiaButtons"
                }), (f = $("<button>", {
                    id: dialog_el_id + "_cancel",
                    type: "button"
                })).append("Cancel"), f.on("click", evhan_cancel_button), c.append(f), (f = $("<button>", {
                    id: dialog_el_id + "_delete",
                    type: "button"
                })).append("Delete"), f.on("click", evhan_delete_button), f.hide(), c.append(f), (f = $("<button>", {
                    id: dialog_el_id + "_display",
                    type: "button"
                })).append("Display"), f.on("click", evhan_display_button), f.hide(), c.append(f), (f = $("<button>", {
                    id: dialog_el_id + "_accept",
                    type: "submit"
                })).append(will_save ? "Save" : "Load"), f.on("click", will_save ? evhan_accept_save_button : evhan_accept_load_button), c.append(f), u.append(c), s.append(d), is_open = !0, evhan_storage_changed(), defer_func(will_save ? function() {
            ...
            function evhan_accept_save_button(e) {
                ...
                if (file_ref_exists(r) && !confirming) return confirming = !0, set_caption("You already have a " + cur_usage_name + ' "' + r.filename + '". Do you want to replace it?', !1), t.prop("disabled", !0), $("#" + dialog_el_id + "_accept").text("Replace"), !1;
                var n = dialog_callback;
            ...
            function evhan_storage_changed() {
                ...
                if (editing && editing_dirent && (file_ref_exists(editing_dirent) || (editing_dirent = null, $("#" + dialog_el_id + "_buttonrow").show(), $("#" + dialog_el_id + "_edit").text("Done"))), editing && editing_dirent) {
                    ...
                    if (n = String.fromCharCode.apply(this, n), usage_is_textual(editing_dirent.usage)) {
                        var l = $("<pre>", {
                            class: "DiaDisplayText"
                        });
                        l.text(n), t.append(l), set_caption("Displaying file contents...", !0)
                    } else {
                        var a = window.btoa(n),
                            o = $("<a>", {
                                href: "data:application/octet-stream;base64," + a,
                                target: "_blank",
                                download: "data"
                            });
                ...
                if (editing) {
                    if (i = files_list(null, cur_gameid), "" != cur_gameid && (i = i.concat(files_list(null, ""))), i.sort((function(e, t) {
                            return e.dirent.usage < t.dirent.usage ? -1 : e.dirent.usage > t.dirent.usage ? 1 : t.modified.getTime() - e.modified.getTime()
                        })), 0 == i.length) return t.empty(), $("#" + dialog_el_id + "_delete").prop("disabled", !0), $("#" + dialog_el_id + "_display").prop("disabled", !0), set_caption("You have no stored files. Press Done to continue.", !0), !1;
                    cur_filelist = [], r = "";
                    for (let e = 0; e < i.length; e++) l = i[e], l.dirent.usage != r && (r = l.dirent.usage, cur_filelist.push({
                        label: r
                    })), cur_filelist.push(l);
                    i = cur_filelist, t.empty();
                    const n = $("<select>", {
                        id: dialog_el_id + "_select",
                        name: "files"
                    });
                    let l, a;
                    n.prop("size", "5");
                    var s = !1;
                    for (let t = 0; t < i.length; t++) l = i[t], l.dirent ? (e = $("<option>", {
                        name: "f" + t
                    }), s || (s = !0, e.selected = !0), a = format_date(l.modified), e.text(l.dirent.filename + " -- " + a), n.append(e)) : ((e = $("<option>", {
                        name: "f" + t
                    })).prop("disabled", !0), e.text("-- " + label_for_usage(l.label) + "s --"), n.append(e));
                    return t.append(n), n.on("change", evhan_select_change_editing), evhan_select_change_editing(), set_caption("All stored files are now visible. You may delete them, and display files containing text. Press Done when finished.", !0), !1
                }
                if ((i = files_list(cur_usage, cur_gameid)).sort((function(e, t) {
                        return t.modified.getTime() - e.modified.getTime()
                    })), cur_filelist = i, 0 == i.length) t.empty();
                else {
                    t.empty();
                    const r = $("<select>", {
                        id: dialog_el_id + "_select",
                    ...
                    let n, l;
                    r.prop("size", "5");
                    for (let t = 0; t < i.length; t++) n = i[t], e = $("<option>", {
                        name: "f" + t
                    }), 0 == t && (e.selected = !0), l = format_date(n.modified), e.text(n.dirent.filename + " -- " + l), r.append(e);
                    t.append(r), will_save && r.on("change", evhan_select_change)
                }
                will_save ? (set_caption("Name this " + cur_usage_name + ".", !0), (e = $("#" + dialog_el_id + "_accept")).prop("disabled", !1)) : 0 == i.length ? (set_caption("You have no " + cur_usage_name + "s for this game.", !0), (e = $("#" + dialog_el_id + "_accept")).prop("disabled", !0)) : (set_caption("Select a " + cur_usage_name + " to load.", !0), (e = $("#" + dialog_el_id + "_accept")).prop("disabled", !1))
            }
            ...
            function file_load_dirent(e) {
                ...
                for (i = 0; i < o.length; i++)
                    if (!((r = (l = o[i]).indexOf(":")) < 0)) switch (n = l.slice(0, r), l = l.slice(r + 1), n) {
                        case "created":
            ...
            function file_write(e, t, i) {
                var r, n, l, a, o = file_load_dirent(e);
                return o || (o = {
                    dirent: e,
                    created: new Date
                }), o.modified = new Date, i || (t = encode_array(t)), n = [], o.created && n.push("created:" + o.created.getTime()), o.modified && n.push("modified:" + o.modified.getTime()), r = n.join(","), l = Storage.setItem(o.dirent.dirent, r), a = Storage.setItem(o.dirent.content, t), !l && !a
            }
            ...
            var encode_array = null,
                decode_array = null;
            window.JSON ? (encode_array = function(e) {
            ...
            try {
                ...
                if (null != window.localStorage ? htmlLocalStorage = window.localStorage : null != window.globalStorage && (htmlLocalStorage = window.globalStorage[location.hostname]), htmlLocalStorage) try {
                    ...
                    htmlLocalStorage.removeItem("_dialogtest"), Storage = {
                        getItem: function(e) {
                            try {
        ...
        Glk = function() {
            ...
            function m(t) {
                ...
                if (t.gen == g) switch (g += 1, h = t.partial, t.type) {
                    case "init":
                        O = t.metrics, t.support && t.support.forEach(e => l[e] = 1), e.init();
                        break;
                    case "external": {
                        let e = null;
                        u && (e = u(t.value)), e || "timer" != t.value || (X = Date.now(), e = {
                            type: b.evtype_Timer
                        }), e && e.type && y(e);
                        break
                    }
                    ...
                    case "arrange":
                        r = {
                                left: (O = t.metrics).outspacingx,
                                top: O.outspacingy,
                                right: O.width - O.outspacingx,
                                bottom: O.height - O.outspacingy
                            }, P && oe(P, r),
                            function() {
                                if (!J) return;
                    ...
                    case "specialresponse":
                        "fileref_prompt" == t.response && function(t) {
                            var r = t.value,
                                n = p.usage,
                                l = p.rock,
                                a = null;
            ...
            ! function() {
                var e, t, i, r = $;
                for (e = [7936, 7937, 7938, 7939, 7940, 7941, 7942, 7943, 7952, 7953, 7954, 7955, 7956, 7957, 7968, 7969, 7970, 7971, 7972, 7973, 7974, 7975, 7984, 7985, 7986, 7987, 7988, 7989, 7990, 7991, 8e3, 8001, 8002, 8003, 8004, 8005, 8017, 8019, 8021, 8023, 8032, 8033, 8034, 8035, 8036, 8037, 8038, 8039, 8112, 8113, 8144, 8145, 8160, 8161], t = 0; t < 54; t++) r[i = e[t]] = i + 8;
            ...
            ! function() {
                ...
                for (e = [306, 308, 310, 313, 315, 317, 319, 321, 323, 325, 327, 377, 379, 381, 386, 388, 391, 395, 401, 408, 416, 418, 420, 423, 428, 431, 435, 437, 440, 444, 453, 456, 459, 461, 463, 465, 467, 469, 471, 473, 475, 478, 480, 482, 484, 486, 488, 490, 492, 494, 498, 500, 546, 548, 550, 552, 554, 556, 558, 560, 562, 984, 986, 988, 990, 992, 994, 996, 998, 1e3, 1002, 1004, 1006, 1015, 1018, 1217, 1219, 1221, 1223, 1225, 1227, 1229, 1272, 1280, 1282, 1284, 1286, 1288, 1290, 1292, 1294], t = 0; t < 91; t++) r[i = e[t]] = i + 1;
                for (e = [7944, 7945, 7946, 7947, 7948, 7949, 7950, 7951, 7960, 7961, 7962, 7963, 7964, 7965, 7976, 7977, 7978, 7979, 7980, 7981, 7982, 7983, 7992, 7993, 7994, 7995, 7996, 7997, 7998, 7999, 8008, 8009, 8010, 8011, 8012, 8013, 8025, 8027, 8029, 8031, 8040, 8041, 8042, 8043, 8044, 8045, 8046, 8047, 8072, 8073, 8074, 8075, 8076, 8077, 8078, 8079, 8088, 8089, 8090, 8091, 8092, 8093, 8094, 8095, 8104, 8105, 8106, 8107, 8108, 8109, 8110, 8111, 8120, 8121, 8152, 8153, 8168, 8169], t = 0; t < 78; t++) r[i = e[t]] = i - 8
            }();
            var q = {
                223: [83, 115],
                452: 453,
            ...
            ! function() {
                var e, t, i, r = q;
                for (e = [8072, 8073, 8074, 8075, 8076, 8077, 8078, 8079, 8072, 8073, 8074, 8075, 8076, 8077, 8078, 8079, 8088, 8089, 8090, 8091, 8092, 8093, 8094, 8095, 8088, 8089, 8090, 8091, 8092, 8093, 8094, 8095, 8104, 8105, 8106, 8107, 8108, 8109, 8110, 8111, 8104, 8105, 8106, 8107, 8108, 8109, 8110, 8111], t = 0; t < 48; t++) i = e[t], r[t + 8064] = i
            }();
            var S = {
                192: [65, 768],
                193: [65, 769],
            ...
            function B(e) {
                ...
                for (let t = 0; t < e.length; t++) {
                    const r = e[t];
                    r < 128 ? i.push(r) : r < 2048 ? (i.push(192 | (1984 & r) >> 6), i.push(128 | 63 & r)) : r < 65536 ? (i.push(224 | (61440 & r) >> 12), i.push(128 | (4032 & r) >> 6), i.push(128 | 63 & r)) : r < 2097152 ? (i.push(240 | (1835008 & r) >> 18), i.push(128 | (258048 & r) >> 12), i.push(128 | (4032 & r) >> 6), i.push(128 | 63 & r)) : i.push(63)
                }
                return i
            }
            ...
            function ne(e) {
                var t, i, r, n, l = e.content,
                    a = x[e.accumstyle];
                if (e.accum.length)
                    for (t = e.accum.join("").split("\n"), i = 0; i < t.length; i++)
                        if (n = void 0, 0 == i ? t[i] && (0 == l.length ? (n = [], l.push({
                                content: n,
                                append: !0
                            })) : (r = l[l.length - 1]).content ? n = r.content : (n = [], r.content = n)) : t[i] ? (n = [], l.push({
                                content: n
                            })) : l.push({}), void 0 !== n)
            ...
            function le(e, t, i) {
                ...
                0 == n.length ? (r = {
                    content: l = [],
                    append: !0
                }, i && (r.flowbreak = !0), n.push(r)) : (r = n[n.length - 1], i && (r.flowbreak = !0), r.content ? l = r.content : (l = [], r.content = l)), void 0 !== l && void 0 !== t && l.push(t)
            }
            ...
            function oe(e, t) {
                var i, r, n, l, a, o, s, u, f, c, d, _, p, g, h, w;
                switch (E = !0, e.bbox = t, e.type) {
                    case b.wintype_TextGrid:
                        if (i = t.right - t.left, r = t.bottom - t.top, l = e.gridheight, e.gridwidth = Math.max(0, Math.floor((i - O.gridmarginx) / O.gridcharwidth)), e.gridheight = Math.max(0, Math.floor((r - O.gridmarginy) / O.gridcharheight)), l > e.gridheight) e.lines.length = e.gridheight;
                        else if (l < e.gridheight)
                            for (c = l; c < e.gridheight; c++) e.lines[c] = {
                                chars: [],
                                styles: [],
                                hyperlinks: [],
                                fgs: [],
                        ...
                        for (c = 0; c < e.gridheight; c++)
                            if ((n = (_ = e.lines[c]).chars.length) > e.gridwidth) _.dirty = !0, _.chars.length = e.gridwidth, _.styles.length = e.gridwidth, _.hyperlinks.length = e.gridwidth, _.fgs.length = e.gridwidth, _.bgs.length = e.gridwidth, _.reverses.length = e.gridwidth;
                            else if (n < e.gridwidth)
                            for (_.dirty = !0, d = n; d < e.gridwidth; d++) _.chars[d] = " ", _.styles[d] = b.style_Normal, _.hyperlinks[d] = 0, _.fgs[d] = null, _.bgs[d] = null, _.reverses[d] = 0;
                        break;
                    case b.wintype_Graphics:
                        ...
                        break;
                    case b.wintype_Pair:
                        e.pair_vertical ? (a = e.bbox.left, o = e.bbox.right, f = O.inspacingx) : (a = e.bbox.top, o = e.bbox.bottom, f = O.inspacingy), e.pair_hasborder || (f = 0), s = o - a, e.pair_division == b.winmethod_Proportional ? u = Math.floor(s * e.pair_size / 100) : e.pair_division == b.winmethod_Fixed ? (u = 0, e.pair_key && e.pair_key.type == b.wintype_TextBuffer && (u = e.pair_vertical ? e.pair_size * O.buffercharwidth + O.buffermarginx : e.pair_size * O.buffercharheight + O.buffermarginy), e.pair_key && e.pair_key.type == b.wintype_TextGrid && (u = e.pair_vertical ? e.pair_size * O.gridcharwidth + O.gridmarginx : e.pair_size * O.gridcharheight + O.gridmarginy), e.pair_key && e.pair_key.type == b.wintype_Graphics && (u = e.pair_vertical ? e.pair_size + O.graphicsmarginx : e.pair_size + O.graphicsmarginy), u = Math.ceil(u)) : u = Math.floor(s / 2), u = e.pair_backward ? a + u : o - u - f, u = a >= o ? a : Math.min(Math.max(u, a), o - f), e.pair_splitpos = u, e.pair_splitwidth = f, g = e.pair_vertical ? {
                            left: (p = {
                                left: e.bbox.left,
                                right: e.pair_splitpos,
                                top: e.bbox.top,
                                bottom: e.bbox.bottom
                            }).right + e.pair_splitwidth,
                            right: e.bbox.right,
                            top: e.bbox.top,
                            bottom: e.bbox.bottom
                        } : {
                            top: (p = {
                                top: e.bbox.top,
                                bottom: e.pair_splitpos,
                                left: e.bbox.left,
                                right: e.bbox.right
                            }).bottom + e.pair_splitwidth,
                            bottom: e.bbox.bottom,
                            left: e.bbox.left,
                            right: e.bbox.right
                        }, e.pair_backward ? (h = e.child2, w = e.child1) : (h = e.child1, w = e.child2), oe(h, p), oe(w, g)
                }
            }

            function se(e, t, r, n) {
                var l = {};
                return l.type = e, l.rock = n, l.disprock = void 0, l.unicode = !1, l.isbinary = !1, l.streaming = !1, l.ref = null, l.win = null, l.file = null, l.buf = null, l.bufpos = 0, l.buflen = 0, l.bufeof = 0, l.timer_id = null, l.flush_func = null, l.fstream = null, l.readcount = 0, l.writecount = 0, l.readable = t, l.writable = r, l.prev = null, l.next = Q, Q = l, l.next && (l.next.prev = l), i && i.class_register("stream", l), l
            }
            ...
            function ue(e) {
                ...
                e === Y && (Y = null),
                    ...
                    }(e), e.type == A ? i && i.unretain_array(e.buf) : e.type == R && e.fstream && (e.fstream.fclose(), e.fstream = null), i && i.class_unregister("stream", e), t = e.prev, r = e.next, e.prev = null, e.next = null, t ? t.next = r : Q = r, r && (r.prev = t), e.fstream = null, e.buf = null, e.readable = !1, e.writable = !1, e.ref = null, e.win = null, e.file = null, e.rock = null, e.disprock = null
            }

            function fe(e) {
                e.streaming && n.log("### gli_stream_dirty_file called for streaming file!"), null === e.timer_id && (null === e.flush_func && (e.flush_func = function() {
                    ce(e)
            ...
            function pe(e, t, i) {
                ...
                switch (e.unicode || i || (t = G(t), i = !0), e.writecount += t.length, e.type) {
                    case R:
                        if (e.streaming)
                            if (e.unicode)
                                if (e.isbinary) {
                ...
                switch (e.type) {
                    case R:
                        ...
                        case N:
                            ...
                            case A:
                                if (0 == a) return 0;
                                if (a -= 1, e.bufpos >= e.bufeof ? a = 0 : e.bufpos + a > e.bufeof && (a = e.bufeof - e.bufpos), l = !1, i)
                                    for (r = 0; r < a && !l; r++) n = e.buf[e.bufpos++], t[r] = n, l = 10 == n;
                                else
                                    for (r = 0; r < a && !l; r++) n = e.buf[e.bufpos++], !i && n >= 256 && (n = 63), t[r] = n, l = 10 == n;
                ...
                switch (e.type) {
                    case R:
                        ...
                        case N:
                            ...
                            case A:
                                if (e.bufpos >= e.bufeof ? l = 0 : e.bufpos + l > e.bufeof && (l = e.bufeof - e.bufpos), i)
                                    for (r = 0; r < l; r++) t[r] = e.buf[e.bufpos++];
                                else
                                    for (r = 0; r < l; r++) n = e.buf[e.bufpos++], !i && n >= 256 && (n = 63), t[r] = n;
            ...
            function ye(e, t, i) {
                ...
                switch (e.writecount += t.length, e.type) {
                    case R:
                        ...
                        break;
                    case A:
                        if ((r = t.length) > e.buflen - e.bufpos && (r = e.buflen - e.bufpos), e.unicode || i)
                            for (let i = 0; i < r; i++) e.buf[e.bufpos + i] = t.charCodeAt(i);
                        else
                            for (let i = 0; i < r; i++) {
            ...
            var Ce = ["margin-left", "text-indent", "text-align", "font-size", "font-weight", "font-style", "font-family", "color", "background-color", "reverse"];

            function qe(e, t, i) {
                if (!e || !e.writable) throw "garglk_set_zcolors: invalid stream";
                t >>= 0, i >>= 0, e.type == z && (-2 !== t && (e.win.fg = -1 === t ? null : "#" + ("000000" + t.toString(16)).slice(-6)), -2 !== i && (e.win.bg = -1 === i ? null : "#" + ("000000" + i.toString(16)).slice(-6)), e.win.echostr && qe(e.win.echostr, t, i))
            }
            ...
            function Ge(e, t) {
                var i, r, n, l, a, o, s, u, f, c = e.slice(0, t);
                for (i = 0, r = 0; r < t; r++)
                    if (l = c[r], void 0 === (a = S[l])) e[i] = l, i++;
                    else if (a instanceof Array)
                    for (n = 0; n < a.length; n++) e[i] = a[n], i++;
                else e[i] = a, i++;
                for (r = 0; r < i;)
                    if (D[e[r]]) {
                        if (r >= i) break;
                        ...
                        if ((s = r) - o >= 2)
                            for (n = s - 1; n > o; n--)
                                for (u = o; u < n; u++) D[e[u]] > D[e[u + 1]] && (f = e[u], e[u] = e[u + 1], e[u + 1] = f)
                    } else r++;
                return i
            }
            return {
                ...
                init: function(l) {
                    ...
                    n = l.GlkOte, e = l.vm, i && i.set_vm(e), l.accept = m, n.init(l), a = l.exit_warning, o = l.do_vm_autosave, s = l.before_select_hook, u = l.extevent_hook, f = l.glk_gestalt_hook, s && s()
                },
                update: function() {
                    var t, r, l, a, u, f, p, h, m, y, v, k = {
                            type: "update",
                            gen: g
                        },
                        T = null,
                    ...
                    if (E)
                        ...
                        switch (a = !1, r = {
                            ...
                            case b.wintype_TextBuffer:
                                if (ne(t), t.content.length && (r.text = t.content.slice(0), t.content.length = 0, a = !0), t.clearcontent && (r.clear = !0, r.bg = t.cleared_bg, r.fg = t.cleared_fg, t.clearcontent = !1, a = !0, r.text || (r.text = []), t.reserve.length = 0), r.text && r.text.length)
                            ...
                            case b.wintype_TextGrid:
                                ...
                                for (r.lines = [], h = 0; h < t.gridheight; h++)
                                    if ((u = t.lines[h]).dirty) {
                                        for (u.dirty = !1, f = [], v = 0, m = 0; m < t.gridwidth;) {
                                            const e = u.styles[m],
                                                i = u.hyperlinks[m],
                                                r = u.fgs[m],
                                                n = u.bgs[m],
                                                a = u.reverses[m];
                                            for (; m < t.gridwidth && u.styles[m] === e && u.hyperlinks[m] === i && u.fgs[m] === r && u.bgs[m] === n && u.reverses[m] === a; m++);
                                            v < m && (i || null != r || null != n || a ? (l = {
                                                style: x[e],
                                                text: u.chars.slice(v, m).join(""),
                                                hyperlink: i,
                                                fg: r,
                                                bg: n,
                                                reverse: a
                                            }, f.push(l)) : (f.push(x[e]), f.push(u.chars.slice(v, m).join(""))), v = m)
                                        }
                                        r.lines.push({
                                            line: h,
                                            content: f
                            ...
                            case b.wintype_Graphics:
                                ...
                                if (r.draw && r.draw.length)
                                    for (h = 0; h < r.draw.length; h++) {
                                        var S = r.draw[h];
                                        "fill" == S.special && void 0 === S.x && void 0 === S.y && void 0 === S.width && void 0 === S.height && (q = t.reserve.length), t.reserve.push(S)
                                    }
                                if (q >= 0) {
                                    var D = null;
                                    for (let e = 0; e < t.reserve.length && e < q; e++) {
                                        const i = t.reserve[e];
                                        "setcolor" == i.special && (D = i)
                                    }
                                    t.reserve.splice(0, q), D && t.reserve.unshift(D)
                                }
                        }
                        a && $.push(r)
                    }
                    for (C = [], t = F; t; t = t.next) r = null, t.char_request && (r = {
                        id: t.disprock,
                        type: "char",
                        gen: t.input_generation
                    }, t.type == b.wintype_TextGrid && (re(t) ? (r.xpos = t.gridwidth, r.ypos = t.gridheight - 1) : (r.xpos = t.cursorx, r.ypos = t.cursory))), t.line_request && (y = "", w && (p = w[t.disprock]) && (y = p), r = {
                        id: t.disprock,
                        type: "line",
                        gen: t.input_generation,
                        maxlen: t.linebuf.length,
                        initial: y
                    }, t.line_input_terminators.length && (r.terminators = t.line_input_terminators), t.type == b.wintype_TextGrid && (re(t) ? (r.xpos = t.gridwidth, r.ypos = t.gridheight - 1) : (r.xpos = t.cursorx, r.ypos = t.cursory))), t.hyperlink_request && (r || (r = {
                        id: t.disprock
                    }), r.hyperlink = !0), t.mouse_request && (r || (r = {
                        id: t.disprock
                    }), r.mouse = !0), r && C.push(r);
                    if (k.windows = T, k.content = $, k.input = C, Z != K && (k.timer = K, Z = K), _ && (k.specialinput = _), d && (k.disable = !0), xe != Te.buffer[0]["background-color"] && (xe = Te.buffer[0]["background-color"], k.page_bg = Te.buffer[0]["background-color"] || ""), w = null, W && (k.autorestore = W), W = null, n.update(k, W), s && s(), o)
                        if (c) e.do_autosave(-1);
                        else if (i) {
                        var M = i.check_autosave();
                        M && e.do_autosave(M)
                    }
                },
                save_allstate: function() {
                    ...
                    for (var r = F; r; r = r.next) {
                        var l = {
                            ...
                            fg: r.fg,
                            reverse: r.reverse,
                            cleared_bg: r.cleared_bg,
                            cleared_fg: r.cleared_fg
                        };
                        if (r.parent && (l.parent = r.parent.disprock), l.str = r.str.disprock, r.echostr && (l.echostr = r.echostr.disprock), l.bbox = {
                                left: r.bbox.left,
                                right: r.bbox.right,
                                top: r.bbox.top,
                                bottom: r.bbox.bottom
                            }, null !== r.linebuf) {
                        ...
                        switch (l.char_request = r.char_request, l.line_request = r.line_request, l.char_request_uni = r.char_request_uni, l.line_request_uni = r.line_request_uni, l.hyperlink_request = r.hyperlink_request, l.mouse_request = r.mouse_request, l.echo_line_input = r.echo_line_input, l.request_echo_line_input = r.request_echo_line_input, l.line_input_terminators = r.line_input_terminators.slice(0), r.type) {
                            ...
                            case b.wintype_TextGrid:
                                ...
                                for (var o = 0; o < r.lines.length; o++) {
                                    var s = r.lines[o];
                                    l.lines.push({
                                        chars: s.chars.slice(0),
                                        styles: s.styles.slice(0),
                                        hyperlinks: s.hyperlinks.slice(0),
                                        fgs: s.fgs.slice(0),
                                        bgs: s.bgs.slice(0),
                                        reverses: s.reverses.slice(0)
                                    })
                                }
                            ...
                            case b.wintype_Graphics:
                                ...
                                break;
                            case b.wintype_Pair:
                                l.pair_dir = r.pair_dir, l.pair_division = r.pair_division, l.pair_key = r.pair_key.disprock, l.pair_keydamage = !1, l.pair_size = r.pair_size, l.pair_hasborder = r.pair_hasborder, l.pair_vertical = r.pair_vertical, l.pair_backward = r.pair_backward, l.child1 = r.child1.disprock, l.child2 = r.child2.disprock
                        }
                        e.windows.push(l)
                    }
                    e.streams = [];
                ...
                restore_allstate: function(e) {
                    ...
                    for (let t = 0; t < e.windows.length; t++) {
                        ...
                        switch (a.parent = i.class_obj_from_id("window", r.parent), a.str = i.class_obj_from_id("stream", r.str), a.echostr = i.class_obj_from_id("stream", r.echostr), a.bbox = {
                                left: r.bbox.left,
                                right: r.bbox.right,
                                top: r.bbox.top,
                                bottom: r.bbox.bottom
                            }, a.input_generation = null, (r.char_request || r.line_request) && (a.input_generation = g), a.linebuf = null, void 0 !== r.linebuf && (a.linebuf = r.linebuf.arr, i.retain_array(a.linebuf, r.linebuf)), a.char_request = r.char_request, a.line_request = r.line_request, a.char_request_uni = r.char_request_uni, a.line_request_uni = r.line_request_uni, a.hyperlink_request = r.hyperlink_request, a.mouse_request = r.mouse_request, a.echo_line_input = r.echo_line_input, a.request_echo_line_input = r.request_echo_line_input, a.line_input_terminators = r.line_input_terminators.slice(0), a.type) {
                            case b.wintype_TextBuffer:
                                a.accum = [], a.accumstyle = a.style, a.accumhyperlink = a.hyperlink, a.accum_fg = a.fg, a.accum_bg = a.bg, a.accum_reverse = a.reverse, a.content = r.reserve.slice(0), a.clearcontent = !1, a.reserve = [], a.stylehints = r.stylehints;
                                break;
                            case b.wintype_TextGrid:
                                ...
                                for (var n = 0; n < r.lines.length; n++) {
                                    ...
                                    a.lines.push({
                                        dirty: !0,
                                        chars: l.chars.slice(0),
                                        styles: l.styles.slice(0),
                                        hyperlinks: l.hyperlinks.slice(0),
                                        fgs: l.fgs.slice(0),
                                        bgs: l.bgs.slice(0),
                                        reverses: l.reverses.slice(0)
                                    })
                                }
                            ...
                            case b.wintype_Graphics:
                                ...
                                break;
                            case b.wintype_Pair:
                                a.pair_dir = r.pair_dir, a.pair_division = r.pair_division, a.pair_key = i.class_obj_from_id("window", r.pair_key), a.pair_keydamage = !1, a.pair_size = r.pair_size, a.pair_hasborder = r.pair_hasborder, a.pair_vertical = r.pair_vertical, a.pair_backward = r.pair_backward, a.child1 = i.class_obj_from_id("window", r.child1), a.child2 = i.class_obj_from_id("window", r.child2)
                        }
                    }
                    ...
                    P = i.class_obj_from_id("window", e.rootwin), Y = i.class_obj_from_id("stream", e.currentstr), e.timer_interval && De(e.timer_interval), Te = e.stylehints, W = e.glkote
                },
                ...
                Const: b,
                RefBox: function() {
                    this.value = void 0, this.set_value = function(e) {
                        this.value = e
                ...
                RefStruct: function() {
                    this.fields = [], this.push_field = function(e) {
                        this.fields.push(e)
                ...
                glk_window_close: function(e, t) {
                    ...
                    if (e !== P && e.parent) {
                        ...
                        for (l = i.bbox, (r = i.parent) ? (r.child1 === i ? r.child1 = n : r.child2 = n, n.parent = r) : (P = n, n.parent = null), me(e.str, t), ae(e, !0), e === i.child1 ? i.child1 = null : e === i.child2 && (i.child2 = null), ae(i, !1), o = !1, a = n; a; a = a.parent) a.type == b.wintype_Pair && a.pair_keydamage && (o = !0, a.pair_keydamage = !1);
                        oe(o ? P : n, l)
                    } else P = null, me(e.str, t), ae(e, !0)
                },
                ...
                glk_window_set_arrangement: function(e, t, i, r) {
                    ...
                    if (a = (l = t & b.winmethod_DirMask) == b.winmethod_Left || l == b.winmethod_Right, o = l == b.winmethod_Left || l == b.winmethod_Above, r || (r = e.pair_key), a && !e.pair_vertical) throw "glk_window_set_arrangement: split must stay horizontal";
                    ...
                    (o && !e.pair_backward || !o && e.pair_backward) && (n = e.child1, e.child1 = e.child2, e.child2 = n), e.pair_dir = l, e.pair_division = t & b.winmethod_DivisionMask, e.pair_key = r, e.pair_size = i, e.pair_hasborder = (t & b.winmethod_BorderMask) == b.winmethod_Border, e.pair_vertical = e.pair_dir == b.winmethod_Left || e.pair_dir == b.winmethod_Right, e.pair_backward = e.pair_dir == b.winmethod_Left || e.pair_dir == b.winmethod_Above, oe(e, e.bbox)
                },
                ...
                glk_window_clear: function(e) {
                    ...
                    switch (e.type) {
                        case b.wintype_TextBuffer:
                            e.accum.length = 0, e.accumstyle = null, e.accumhyperlink = 0, e.accum_fg = null, e.accum_bg = null, e.accum_reverse = null, e.content.length = 0, e.clearcontent = !0, e.cleared_bg = e.bg, e.cleared_fg = e.fg;
                            break;
                        case b.wintype_TextGrid:
                        ...
                        case b.wintype_Graphics:
                            ...
                            e.content.length = 0, null !== t && e.content.push(t), e.content.push({
                                special: "fill"
                            })
                    }
                },
                ...
                glk_stream_open_file: function(e, i, r) {
                    ...
                    return (n = se(R, i != b.filemode_Write, i != b.filemode_Read, r)).unicode = !1, n.isbinary = !e.textmode, n.ref = e.ref, n.origfmode = i, t.streaming ? (n.streaming = !0, n.fstream = l, n.buffer4 = l.BufferClass.alloc(4)) : (n.streaming = !1, n.buf = a, n.buflen = 4294967295, i == b.filemode_Write ? n.bufeof = 0 : n.bufeof = a.length, i == b.filemode_WriteAppend ? n.bufpos = n.bufeof : n.bufpos = 0), n
                },
                glk_stream_open_memory: function(e, t, r) {
                    ...
                    return (n = se(A, t != b.filemode_Write, t != b.filemode_Read, r)).unicode = !1, e && (n.buf = e, n.buflen = e.length, n.bufpos = 0, t == b.filemode_Write ? n.bufeof = 0 : n.bufeof = n.buflen, i && i.retain_array(e)), n
                },
                glk_stream_close: function(e, i) {
                    ...
                    e.type == R && e.writable && (e.streaming || (null !== e.timer_id && (clearTimeout(e.timer_id), e.timer_id = null), t.file_write(e.ref, e.buf))), me(e, i), ue(e)
                },
                ...
                glk_fileref_create_by_prompt: function(t, i, r) {
                    var n, l = t & b.fileusage_TypeMask,
                        a = T[l];
                    switch (a || (a = "xxx"), i) {
                ...
                glk_stylehint_set: function(e, t, i, r) {
                    var n;
                    i === b.stylehint_Indentation && (n = r + "em"), i === b.stylehint_ParaIndentation && (n = r + "em"), i === b.stylehint_Justification && (n = ["left", "justify", "center", "right"][r]), i === b.stylehint_Size && (n = 1 + .1 * r + "em"), i === b.stylehint_Weight && (n = ["lighter", "normal", "bold"][r + 1]), i === b.stylehint_Oblique && (n = r ? "italic" : "normal"), i === b.stylehint_Proportional && (n = r ? "var(--glkote-prop-family)" : "var(--glkote-mono-family)"), i === b.stylehint_TextColor && (n = "#" + ("000000" + r.toString(16)).slice(-6)), i === b.stylehint_BackColor && (n = "#" + ("000000" + r.toString(16)).slice(-6)), i === b.stylehint_ReverseColor && (n = r), e !== b.wintype_AllTypes && e !== b.wintype_TextBuffer || (Te.buffer[t][Ce[i]] = n), e !== b.wintype_AllTypes && e !== b.wintype_TextGrid || (Te.grid[t][Ce[i]] = n)
                },
                glk_stylehint_clear: function(e, t, i) {
                    e !== b.wintype_AllTypes && e !== b.wintype_TextBuffer || delete Te.buffer[t][Ce[i]], e !== b.wintype_AllTypes && e !== b.wintype_TextGrid || delete Te.grid[t][Ce[i]]
                },
                ...
                glk_request_line_event: function(e, t, r) {
                    ...
                    if (r) {
                        var n = t.slice(0, r);
                        w || (w = {}), w[e.disprock] = I(n)
                    }
                    e.line_request = !0, e.line_request_uni = !1, e.type == b.wintype_TextBuffer ? e.request_echo_line_input = e.echo_line_input : e.request_echo_line_input = !0, e.input_generation = g, e.linebuf = t, i && i.retain_array(t)
                },
                glk_cancel_line_event: function(e, t) {
                    if (!e) throw "glk_cancel_line_event: invalid window";
                    if (e.line_request) {
                        var r, n, l = "";
                        for (h && (n = h[e.disprock]) && (l = n), l.length > e.linebuf.length && (l = l.slice(0, e.linebuf.length)), e.request_echo_line_input && (r = e.style, be(e.str, b.style_Input), ie(e, l), e.echostr && ye(e.echostr, l), be(e.str, r), ie(e, "\n"), e.echostr && ye(e.echostr, "\n")), r = 0; r < l.length; r++) e.linebuf[r] = l.charCodeAt(r);
                        t && (t.set_field(0, b.evtype_LineInput), t.set_field(1, e), t.set_field(2, l.length), t.set_field(3, 0)), i && i.unretain_array(e.linebuf), e.line_request = !1, e.line_request_uni = !1, e.request_echo_line_input = null, e.input_generation = null, e.linebuf = null
                ...
                glk_buffer_to_lower_case_uni: function(e, t) {
                    var i, r, n, l, a, o = e.length,
                        s = e.slice(0, t);
                    if (o < t) throw "buffer_to_lower_case_uni: numchars exceeds array length";
                    for (n = 0, i = 0; i < t; i++)
                        if (a = s[i], void 0 === (l = C[a])) e[n] = a, n++;
                        else if (l instanceof Array)
                        for (r = 0; r < l.length; r++) e[n] = l[r], n++;
                    else e[n] = l, n++;
                    return e.length = o, n
                },
                ...
                glk_buffer_to_title_case_uni: function(e, t, i) {
                    var r, n, l, a, o, s = e.length,
                        u = e.slice(0, t);
                    if (s < t) throw "buffer_to_title_case_uni: numchars exceeds array length";
                    if (l = 0, 0 == t) return 0;
                    if (o = u[r = 0], void 0 === (a = q[o]) && (a = $[o]), void 0 === a) e[l] = o, l++;
                    else if (a instanceof Array)
                        for (n = 0; n < a.length; n++) e[l] = a[n], l++;
                    else e[l] = a, l++;
                    if (i)
                        for (r = 1; r < t; r++)
                            if (o = u[r], void 0 === (a = C[o])) e[l] = o, l++;
                            else if (a instanceof Array)
                        for (n = 0; n < a.length; n++) e[l] = a[n], l++;
                    else e[l] = a, l++;
                    else
                        for (r = 1; r < t; r++) o = u[r], e[l] = o, l++;
                    return e.length = s, l
                },
                glk_buffer_canon_decompose_uni: function(e, t) {
                    var i, r = e.length;
                    return i = Ge(e, t), e.length = r, i
                },
                glk_buffer_canon_normalize_uni: function(e, t) {
                    ...
                    return i = function(e, t) {
                        ...
                        for (u = 0, n = e[0], (a = D[n]) && (a = 999), r = i = 1;;) {
                            ...
                            l = e[r], o = D[l], void 0 !== (s = M[n]) && void 0 !== s[l] && (!a || o && a < o) ? (n = s[l], e[u] = n) : (o || (u = i, n = l), a = o, e[i] = l, i++), r++
                        }
                        return u
                    }(e, i = Ge(e, t)), e.length = r, i
                },
                ...
                glk_stream_open_file_uni: function(e, i, r) {
                    ...
                    return (n = se(R, i != b.filemode_Write, i != b.filemode_Read, r)).unicode = !0, n.isbinary = !e.textmode, n.ref = e.ref, n.origfmode = i, t.streaming ? (n.streaming = !0, n.fstream = l, n.buffer4 = l.BufferClass.alloc(4)) : (n.streaming = !1, n.buf = a, n.buflen = 4294967295, i == b.filemode_Write ? n.bufeof = 0 : n.bufeof = a.length, i == b.filemode_WriteAppend ? n.bufpos = n.bufeof : n.bufpos = 0), n
                },
                glk_stream_open_memory_uni: function(e, t, r) {
                    var n;
                    if (t != b.filemode_Read && t != b.filemode_Write && t != b.filemode_ReadWrite) throw "glk_stream_open_memory: illegal filemode";
                    return (n = se(A, t != b.filemode_Write, t != b.filemode_Read, r)).unicode = !0, e && (n.buf = e, n.buflen = e.length, n.bufpos = 0, t == b.filemode_Write ? n.bufeof = 0 : n.bufeof = n.buflen, i && i.retain_array(e)), n
                },
                ...
                glk_request_line_event_uni: function(e, t, r) {
                    ...
                    if (r) {
                        var n = t.slice(0, r);
                        w || (w = {}), w[e.disprock] = j(n)
                    }
                    e.line_request = !0, e.line_request_uni = !0, e.type == b.wintype_TextBuffer ? e.request_echo_line_input = e.echo_line_input : e.request_echo_line_input = !0, e.input_generation = g, e.linebuf = t, i && i.retain_array(t)
                },
                ...
                glk_time_to_date_utc: function(e, t) {
                    var i = 4294967296e3 * e.get_field(0) + 1e3 * e.get_field(1) + e.get_field(2) / 1e3,
                        r = new Date(i);
                    t.set_field(0, r.getUTCFullYear()), t.set_field(1, 1 + r.getUTCMonth()), t.set_field(2, r.getUTCDate()), t.set_field(3, r.getUTCDay()), t.set_field(4, r.getUTCHours()), t.set_field(5, r.getUTCMinutes()), t.set_field(6, r.getUTCSeconds()), t.set_field(7, 1e3 * r.getUTCMilliseconds())
                },
                glk_time_to_date_local: function(e, t) {
                    var i = 4294967296e3 * e.get_field(0) + 1e3 * e.get_field(1) + e.get_field(2) / 1e3,
                        r = new Date(i);
                    t.set_field(0, r.getFullYear()), t.set_field(1, 1 + r.getMonth()), t.set_field(2, r.getDate()), t.set_field(3, r.getDay()), t.set_field(4, r.getHours()), t.set_field(5, r.getMinutes()), t.set_field(6, r.getSeconds()), t.set_field(7, 1e3 * r.getMilliseconds())
                },
                glk_simple_time_to_date_utc: function(e, t, i) {
                    var r = new Date(e * (1e3 * t));
                    i.set_field(0, r.getUTCFullYear()), i.set_field(1, 1 + r.getUTCMonth()), i.set_field(2, r.getUTCDate()), i.set_field(3, r.getUTCDay()), i.set_field(4, r.getUTCHours()), i.set_field(5, r.getUTCMinutes()), i.set_field(6, r.getUTCSeconds()), i.set_field(7, 1e3 * r.getUTCMilliseconds())
                },
                glk_simple_time_to_date_local: function(e, t, i) {
                    var r = new Date(e * (1e3 * t));
                    i.set_field(0, r.getFullYear()), i.set_field(1, 1 + r.getMonth()), i.set_field(2, r.getDate()), i.set_field(3, r.getDay()), i.set_field(4, r.getHours()), i.set_field(5, r.getMinutes()), i.set_field(6, r.getSeconds()), i.set_field(7, 1e3 * r.getMilliseconds())
                },
                glk_date_to_time_utc: function(e, t) {
                    var i = new Date(0);
                    i.setUTCFullYear(e.get_field(0)), i.setUTCMonth(e.get_field(1) - 1), i.setUTCDate(e.get_field(2)), i.setUTCHours(e.get_field(4)), i.setUTCMinutes(e.get_field(5)), i.setUTCSeconds(e.get_field(6)), i.setUTCMilliseconds(e.get_field(7) / 1e3);
                    var r, n = i.getTime();
                ...
                glk_date_to_time_local: function(e, t) {
                    var i, r = new Date(e.get_field(0), e.get_field(1) - 1, e.get_field(2), e.get_field(4), e.get_field(5), e.get_field(6), e.get_field(7) / 1e3).getTime();
                ...
                glk_stream_open_resource: function(e, t) {
                    ...
                    var l = n.data,
                        a = "BINA" == n.type;
                    return (i = se(N, !0, !1, t)).unicode = !1, i.isbinary = a, i.resfilenum = e, i.streaming = !1, l && (i.buf = l, i.buflen = l.length, i.bufpos = 0, i.bufeof = i.buflen), i
                },
                glk_stream_open_resource_uni: function(e, t) {
                    ...
                    var l = n.data,
                        a = "BINA" == n.type;
                    return (i = se(N, !0, !1, t)).unicode = !0, i.isbinary = a, i.resfilenum = e, i.streaming = !1, l && (i.buf = l, i.buflen = l.length, i.bufpos = 0, i.bufeof = i.buflen), i
                },
                garglk_set_zcolors: function(e, t) {
                    qe(Y, e, t)
                },
                garglk_set_zcolors_stream: qe,
        ...
        GlkOte = function() {
            ...
            function Y() {
                ...
                f.text("This should not be visible"), f.css({
                    position: "absolute",
                    visibility: "hidden",
                    left: "-1000px"
                });
                ...
                if (e) {
                    if (null == (i = c[e.id])) {
                        ...
                        i = {
                            ...
                            type: e.type,
                            rock: e.rock
                        }, c[e.id] = i, "grid" == i.type && (l = "GridWindow"), "buffer" == i.type && (l = "BufferWindow"), "graphics" == i.type && (l = "GraphicsWindow");
                        var a = "WindowRock_" + e.rock;
                        (t = $("<div>", {
                            id: o,
                            class: "WindowFrame " + l + " " + a
                        })).data("winid", e.id), t.on("mousedown", e.id, be), "buffer" == i.type && t.on("scroll", e.id, Se), "grid" != i.type && "graphics" != i.type || t.on("click", i.id, ve), "buffer" == i.type && t.attr({
                            "aria-live": "polite",
                            "aria-atomic": "false",
                            "aria-relevant": "additions"
                        }), i.frameel = t, i.gridheight = 0, i.gridwidth = 0, i.input = null, i.inputel = null, i.terminators = {}, i.reqhyperlink = !1, i.reqmouse = !1, i.needscroll = !1, i.needspaging = !1, i.topunseen = 0, i.pagefrommark = 0, i.coords = {
                            left: null,
                            top: null,
                            right: null,
                            bottom: null
                        }, i.history = new Array, i.historypos = 0, e.stylehints && (i.stylehints = e.stylehints, te(i, t)), $("#" + n, r).append(t)
                    ...
                    if (i.type, "graphics" == i.type) {
                        ...
                        if (o.length) {
                            if (i.graphwidth != e.graphwidth || i.graphheight != e.graphheight) {
                                i.graphwidth = e.graphwidth, i.graphheight = e.graphheight, o.attr("width", i.graphwidth * i.scaleratio), o.attr("height", i.graphheight * i.scaleratio), o.css("width", i.graphwidth + "px"), o.css("height", i.graphheight + "px");
                                let t = ue(o);
                    ...
                    u = {
                        ...
                        right: f + "px",
                        bottom: p + "px"
                    }, i.coords.left = e.left, i.coords.top = e.top, i.coords.right = f, i.coords.bottom = p, t.css(u)
                }
            }
            ...
            function K(e) {
				try {
					if (e.id == 102) {
						for (var zjj = 0; e.text && zjj < e.text.length; zjj++) {
							var jtmp = e.text[zjj];
							if (jtmp) {
                    ...
                    if (i.input && "line" == i.input.type) ne("Got content update for window " + e.id + ", which is awaiting line input.");
                                    ...
                                    if (o && o.length) {
                                        ...
                                        for (let e = 0; e < o.length; e++) {
                                            ...
                                            if ("object" === jQuery.type(p)) {
                                                ...
                                                u = p.style, f = p.text, _ = p.hyperlink, g = p.fg, h = p.bg, m = p.reverse
                                            } else u = p, e++, f = o[e], _ = void 0;
                                            let t = "Style_" + u;
                                            (m = m || i.stylehints && i.stylehints[Q[u]].reverse) && (t += " reverse");
                                            var y = $("<span>", {
                                                class: t
                                            });
                                            if (g || h) {
                                                const e = {};
                                                g && (e[m ? "background-color" : "color"] = g), h && (e[m ? "color" : "background-color"] = h), y.css(e)
                                            }
                                            if (_) {
                                                var b = $("<a>", {
                                                    href: "#",
                        ...
                        if ("buffer" == i.type) {
                            ...
                            for (let e = 0; e < v.length; e++) {
                                ...
                                if (null == n && (n = $("<div>", {
                                        class: "BufferLine"
                                    }), n.data("blankpara", !0), r && r[0] && n.addClass("Style_" + ("string" == typeof r[0] ? r[0] : r[0].style)), i.frameel.append(n)), x.flowbreak && n.addClass("FlowBreak"), r && r.length) {
                                ...
                                } else n.data("blankpara") && n.append($("<span>", {
                                    class: "BlankLineSpan"
                                }).text(" "))
                            }
                            var q = i.frameel.children();
                            if (q.length) {
                                var S = q.length - 200;
                                if (S > 0) {
                                    var D = q.get(S).offsetTop;
                            ...
                            if (n && ((k = $("<span>", {
                                ...
                                })).append(" "), n.append(k), i.inputel)) {
                                var M = i.inputel,
                                    G = k.position(),
                                    I = i.frameel.width() - (d.buffermarginx + G.left + 2);
                                if (I < 1 && (I = 1), M.css({
                                        position: "absolute",
                                        left: "0px",
                                        top: "0px",
                                        width: I + "px"
                                    }), i.lastrdesc && "line" === i.input.type) {
                                    const e = i.lastrdesc;
                                    if (M.toggleClass("reverse", !!e.reverse), e.fg || e.bg) {
                                        const t = {};
                                        t[e.reverse ? "background-color" : "color"] = e.fg || "", t[e.reverse ? "color" : "background-color"] = e.bg || "", M.css(t)
                                    }
                                }
                                k.append(M)
                            }
                        ...
                        if ("graphics" == i.type) {
                            ...
                            for (let e = 0; e < j.length; e++) {
                                ...
                                jQuery.extend(U, L), w.push(U)
                            }
                            B && w.length > 0 && function e(i, n) {
                                if (0 == w.length) return void re("perform_graphics_ops called with no queued ops" + (i ? " (plus image!)" : ""));
                                for (; w.length;) {
                                    var l = w[0],
                                        a = c[l.winid];
                                    if (a) {
                                        ...
                                        if (o) {
                                            ...
                                            switch (s) {
                                                case "setcolor":
                                                    ...
                                                    break;
                                                case "fill":
                                                    void 0 === l.color ? o.fillStyle = a.defcolor : o.fillStyle = l.color, void 0 === l.x ? (o.fillRect(0, 0, a.graphwidth, a.graphheight), a.frameel.css("background-color", o.fillStyle)) : o.fillRect(l.x, l.y, l.width, l.height), o.fillStyle = "#000000";
                                                    break;
                                                case "image":
                                                    if (!i) {
                                                        var u = E[l.image];
                                            ...
                                            w.shift()
                                        } else re("perform_graphics_ops: op for nonexistent canvas " + a.id), w.shift()
                                    } else re("perform_graphics_ops: op for nonexistent window " + l.winid), w.shift()
                                }
                            }(null)
                        }
                    }
            ...
            function X(e) {
                var t, i, r = $((t = e.frameel, (i = t.children()) && i.length ? i.get(i.length - 1) : null));
            ...
            function ee(e) {
                h = 0;
                var t = 0;
                if (jQuery.each(c, (function(e, i) {
                        i.needspaging && (h += 1, t && i.id != g || (t = i.id))
                    })), h && (g = t), !h && e) {
                    var i = 0;
                    if (s || h || jQuery.each(c, (function(e, t) {
            ...
            function te(e, t) {
                    ...
                    for (const t in n)
                        if ("reverse" !== t && ("font-family" !== t || "buffer" === e.type))
                            if ("margin-left" === t || "text-align" === t || "text-indent" === t) l.push(`${t}: ${n[t]}`);
                                ...
                                a.push(`${t}: ${n[t]}`)
                            } if (l.length && r.push(`#${i} div.Style_${O[t]} {${l.join("; ")}}`), a.length && (r.push(`#${i} span.Style_${O[t]} {${a.join("; ")}}`), 8 === t && r.push(`#${i} input.LineInput {${a.join("; ")}}`)), n.color || n["background-color"]) {
                        let e = [];
                ...
                }(e.stylehints.win_bg || e.stylehints.win_fg || e.stylehints[0]["background-color"]) && r.push(`#${i} {background-color: ${e.stylehints.win_bg||e.stylehints[0]["background-color"]||`var(--glkote-${e.type}-bg)`}}`, `#${i}.reverse {background-color: ${e.stylehints.win_fg||e.stylehints[0].color||`var(--glkote-${e.type}-reverse-bg)`}}`), r.length && (t.children("style").remove(), t.prepend(`<style>${r.join("\n")}</style>`))
            }
            ...
            function pe(e) {
                jQuery.ajax(F, {
                    ...
                    error: function(e, t, i) {
                        re("Transcript recording failed; deactivating. Error " + t + ": " + i), A = !1
                    }
                })
            }

            function ge() {
                null != b && (window.clearTimeout(b), b = null), b = fe(.2, he)
            }

            function he() {
                if (b = null, s) b = fe(.2, he);
                else {
                    var e, t, i = Y();
                    if (t = d, (e = i).width != t.width || e.height != t.height || e.gridcharwidth != t.gridcharwidth || e.gridcharheight != t.gridcharheight || e.buffercharwidth != t.buffercharwidth || e.buffercharheight != t.buffercharheight) _e("arrange", null, d = i)
                }
            }
            ...
            function me() {
                ...
                e != _ && (re("### devicePixelRatio changed to " + (_ = e)), jQuery.each(c, (function(e, t) {
                    if ("graphics" == t.type) {
                        var i = $("#win" + t.id + "_canvas", r);
                        t.scaleratio = _ / t.backpixelratio;
                        var n = ue(i);
                        i.attr("width", t.graphwidth * t.scaleratio), i.attr("height", t.graphheight * t.scaleratio), i.css("width", t.graphwidth + "px"), i.css("height", t.graphheight + "px"), n && (n.setTransform(t.scaleratio, 0, 0, t.scaleratio, 0, 0), n.fillStyle = t.defcolor, n.fillRect(0, 0, t.graphwidth, t.graphheight), n.fillStyle = "#000000"), t.frameel.css("background-color", t.defcolor), ce((function() {
                            we(e)
                        }))
                    }
                })))
                ...
                if (!s) {
                    ...
                    if (e && (i = e.which), "INPUT" != e.target.tagName.toUpperCase())
                        ...
                        if (t.inputel.focus(), "line" != t.input.type) {
                            var f = null;
                            return 13 == i ? f = "return" : i == C ? f = "delete" : i && (f = String.fromCharCode(i)), f && _e("char", t, f), void e.preventDefault()
                        }
            ...
            function Te(e) {
                ...
                if (t == M || t == I) {
                    var i = $(this).data("winid"),
                        r = c[i];
                    return !r || !r.input || (t == M && r.historypos > 0 && (r.historypos -= 1, r.historypos < r.history.length ? this.value = r.history[r.historypos] : this.value = ""), t == I && r.historypos < r.history.length && (r.historypos += 1, r.historypos < r.history.length ? this.value = r.history[r.historypos] : this.value = ""), !1)
                }
                if (z[t]) {
            ...
            function Me() {
                m && y && (m = window.setTimeout(Me, y), s || _e("timer"))
            }
            ...
            return {
                        ...
                        if (a.accept)
                            if (i = a, a.Dialog && (e = a.Dialog), a.GiLoad && (t = a.GiLoad), window.jQuery && jQuery.fn.jquery) {
                                ...
                                if (o.length < 2 || o[0] < 1 || 1 == o[0] && o[1] < 9) ne("This version of the jQuery library is too old. (Version " + jQuery.fn.jquery + " found; 1.9.0 required.)");
                                    ...
                                    var f = $("#" + n, r);
                                    if (f.length) {
                                        f.empty(), $(document).on("keypress", ye), $(window).on("resize", ge), _ = window.devicePixelRatio || 1, window.matchMedia && (window.matchMedia("screen and (min-resolution: 1.5dppx)").addListener(me), window.matchMedia("screen and (min-resolution: 2dppx)").addListener(me), window.matchMedia("screen and (min-resolution: 3dppx)").addListener(me), window.matchMedia("screen and (min-resolution: 4dppx)").addListener(me));
                                        var p = Y();
                                        if ("string" !== jQuery.type(p)) {
                                            if (d = p, function() {
                                                ...
                                                }(), (k = a.detect_external_links) && ((x = a.regex_external_links) || (x = "search" == k ? RegExp("\\b((?:https?://)(?:[^\\s()<>]+|\\(([^\\s()<>]+|(\\([^\\s()<>]+\\)))*\\))+(?:\\(([^\\s()<>]+|(\\([^\\s()<>]+\\)))*\\)|[^\\s`!()\\[\\]{};:'\".,<>?«»“”‘’]))", "i") : RegExp("^https?:", "i"))), a.recording_url && (A = !0, W = pe, F = a.recording_url), a.recording_handler && (A = !0, W = a.recording_handler, F = "(custom handler)"), A) {
                                                var g = function() {
                                                    var e = {},
                                                ...
                                                "undefined" != jQuery.type(g) && "1" != g ? (A = !1, re("User has opted out of transcript recording.")) : (N = {
                                                    sessionId: (new Date).getTime() + "" + Math.ceil(1e4 * Math.random()),
                                                    input: null,
                                                    output: null,
                                                    timestamp: 0,
                                                    outtimestamp: 0
                                                }, a.recording_label && (N.label = a.recording_label), "simple" == a.recording_format ? N.format = "simple" : N.format = "glkote", re("Transcript recording active: session " + N.sessionId + ' "' + N.label + '", destination ' + F))
                                            }
                                            if (a.debug_commands) {
                                                var h = window.GiDebug;
                                                1 != a.debug_commands && (h = a.debug_commands), h ? (h.init(Ge), T = h.output, a.debug_console_open && h.open()) : re("The debug_commands option is set, but there is no GiDebug module.")
                                            }
                                            a.font_load_delay ? (s = !0, ce((function() {
                ...
                update: function(t) {
                    ae();
                    var i = null;
                    if (t.autorestore && 0 == a && (i = t.autorestore), delete t.autorestore, A && function(e) {
                            N.output = e, N.outtimestamp = (new Date).getTime();
                            var t = !0;
                            if ("simple" == N.format) {
                                var i = N.input,
                                    r = N.output,
                                    n = null;
                                if (i && (n = i.type), "line" == n || "char" == n ? N.input = i.value : "init" != n && "external" != n && "specialresponse" != n && n ? t = !1 : N.input = "", r.windows) {
                                    P.bufferwins = {};
                            ...
                            t && W(N);
                            N.input = null, N.output = null, N.timestamp = 0, N.outtimestamp = 0
                        }(t), t.debugoutput && T && T(t.debugoutput), "error" != t.type) {
                        if ("pass" != t.type)
                            if ("retry" != t.type)
                                if ("update" == t.type)
                                    if (t.gen != a)
                                        if (t.gen < a) re("Ignoring out-of-order generation number: got " + t.gen + ", currently at " + a);
                                            ...
                                            a = t.gen, s && (jQuery.each(c, (function(e, t) {
                                                t.inputel && t.inputel.prop("disabled", !1)
                                            })), s = !1), null != t.input && function(e) {
                                                var t = {};
                                            ...
                                            }(t.input), null != t.windows && function(e) {
                                                ...
                                                jQuery.map(t, V)
                                            }(t.windows), null != t.content && function(e) {
                                                jQuery.map(e, K)
                                            }(t.content), null != t.input && function(e) {
                                                var t = {},
                                                    i = {},
                                                    n = {};
                                                jQuery.map(e, (function(e) {
                                                    ...
                                                    if (null != a) {
                                                        ...
                                                        if (null == u) {
                                                            s = !0;
                                                            var f = "Input";
                                                            if ("line" == a.type ? f += " LineInput" : "char" == a.type ? f += " CharInput" : ne("Window " + l.id + " has requested unrecognized input type " + a.type + "."), (u = $("<input>", {
                                                                    id: "win" + l.id + "_input",
                                                                    class: f,
                                                                    type: "text",
                                                                    maxlength: o
                                                                })).attr("autocapitalize", "off"), u.attr({
                                                                    "aria-live": "off"
                                                                }), "line" == a.type) {
                                                                if (u.on("keypress", $e), u.on("keydown", Te), a.initial && u.val(a.initial), l.terminators = {}, a.terminators)
                                                                    for (var c = 0; c < a.terminators.length; c++) l.terminators[a.terminators[c]] = !0
                                                            } else "char" == a.type && (u.on("keypress", xe), u.on("keydown", ke));
                                                            if (u.on("focus", l.id, Ce), u.on("blur", l.id, qe), u.data("winid", l.id), l.inputel = u, l.historypos = l.history.length, l.needscroll = !0, l.lastrdesc && "line" === l.input.type) {
                                                                const e = l.lastrdesc;
                                                        ...
                                                        if ("grid" == l.type) {
                                                            ...
                                                            var p = _.position(),
                                                                ...
                                                                w = l.frameel.width() - (d.buffermarginx + g + 2);
                                                            h > w && (h = w), u.css({
                                                                position: "absolute",
                                                                left: g + "px",
                                                                top: p.top + "px",
                                                                width: h + "px"
                                                            }), s && l.frameel.append(u)
                                                        }
                                                        if ("buffer" == l.type) {
                                                            var m = $("#win" + l.id + "_cursor", r);
                                                            m.length || ((m = $("<span>", {
                                                                id: "win" + l.id + "_cursor",
                                                                class: "InvisibleCursor"
                                                            })).append(" "), l.frameel.append(m));
                                                            const e = m.position();
                                            ...
                                            }(t.input), void 0 !== t.timer && function(e) {
                                                m && (window.clearTimeout(m), m = null, y = null);
                                                e && (y = e, m = window.setTimeout(Me, y))
                                            }(t.timer), null != t.specialinput && function(t) {
                                                ...
                                                if ("buffer" == t.type && t.needscroll && (t.needscroll = !1, !t.needspaging)) {
                                                    ...
                                                    if (t.needspaging) {
                                                        ...
                                                        u.length || (u = $("<div>", {
                                                            id: "win" + t.id + "_prevmark",
                                                            class: "PreviousMark"
                                                        }), i.prepend(u)), u.css("top", t.pagefrommark + "px")
                                                    } else s.length && s.remove(), u.length && u.remove()
                                                }
                                            })), ee(!1), s = !1, (t.disable || t.specialinput) && (s = !0, jQuery.each(c, (function(e, t) {
                                            ...
                                            i && (i.history && jQuery.each(i.history, (function(e, t) {
                                                const i = c[e];
                                                null != i && (i.history = t.slice(0), i.historypos = i.history.length)
                                            })), i.defcolor && jQuery.each(i.defcolor, (function(e, t) {
                                                const i = c[e];
                                                null != i && (i.defcolor = t)
                                            })), jQuery.each(c, (function(e, t) {
                                                "buffer" == t.type && function(e) {
                                                    var t = e.frameel,
                                                        i = t.outerHeight();
                                            ...
                                            })), i.metrics && i.metrics.width == d.width && i.metrics.height == d.height || (d.width += 2, ge())), void 0 !== t.page_bg && H.css("background-color", t.page_bg)
                                        }
                        else re("Ignoring repeated generation number: " + a);
                        else re("Ignoring unknown message type " + t.type + ".");
                        else v ? re("Event has timed out, but a retry is already queued!") : (re("Event has timed out; will retry..."), function() {
                            if (1 == u) return;
                            u = !0;
                            var e = document.getElementById("loadingpane");
                            e && (e.style.display = "")
    ...
    function text_to_array(e) {
        const t = [];
        let i, r = 0;
        for (i = e.length % 8; r < i; ++r) t.push(255 & e.charCodeAt(r));
        for (i = e.length; r < i;) t.push(255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++), 255 & e.charCodeAt(r++));
        return t
    }

    function launch() {
        const e = window.parchment_options;
        if (!e || !e.default_story) return GlkOte.error("No storyfile specified");
        const t = e.default_story[0];
        let i;
        if (/zblorb|z3|z4|z5|z8/.test(t)) i = "zcode";
        else {
            if (!/gblorb|ulx/.test(t)) return GlkOte.error("Unknown storyfile format");
            i = "glulx"
        }
        $.ajaxSetup({
            cache: !0,
            crossDomain: !0
        }), $.getScript(e.lib_path + ("zcode" === i ? "zvm.js" : "quixe.js")).catch(e => {
            GlkOte.error("Error loading engine: " + e.status)
        }).then(() => $.ajax({
            dataType: "jsonp",
            jsonp: !1,
            ...
            GlkOte.error("Error loading storyfile: " + e.status)
        }).then(t => {
            const r = text_to_array(atob(t));
            if ("zcode" === i) {
                const t = new window.ZVM,
                    i = Uint8Array.from(r),
                    n = Object.assign({}, e, {
                        vm: t,
                        Dialog: Dialog,
                ...
                t.prepare(i, n), Glk.init(n)
            }
            if ("glulx" === i) {
                window.Glk = Glk, window.GlkOte = GlkOte;
                ...
                window.GiLoad.load_run(t, r, "array")
            }
        }).catch(e => {
            GlkOte.error(e)
        })
